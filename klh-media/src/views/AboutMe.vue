  ...
  <div class="about-me-container">
    <div class="container-fluid">
      ...
      <div class="rounded-box">
        <h3>
          Liviniti
          <span class="work-dates">October 2024 &ndash; August 2025</span>
        </h3>
        <p>
        ...
        <h3 class="mt-5">
          Talis Clinical LLC
          <span class="work-dates">June 2021 &ndash; October 2024</span>
        </h3>
        <p>
        ...
        <h3 class="mt-5">
          New Elevation
          <span class="work-dates">January 2020 &ndash; December 2020</span>
        </h3>
        <p>
        ...
        <h3 class="mt-5">
          ...
          <span class="work-dates">April 2014 &ndash; December 2019</span>
        </h3>
        <p>
        ...
        <h3 class="mt-5">
          Brunner
          <span class="work-dates">January 2011 &ndash; March 2014</span>
        </h3>
        <p>
      ...
      <div class="rounded-box">
        ...
        <h3 class="mt-5">
          ...
          <span class="work-dates">October 2006 &ndash; October 2008</span>
        </h3>
        <p>
        ...
        <h3 class="mt-5">
          ...
          <span class="work-dates">August 2002 &ndash; May 2004</span>
        </h3>
        <p>
...
@forward "@/assets/scss/pages/about";
</style>
